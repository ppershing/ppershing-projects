// FILE: winbgim.h
// WINBGIM Version 3.41 -- Mar 22, 2001
...
//
//  Modification log by Michael Serrano:
// --Version 3.41: Mar 22, 2001
//   Made modification to work-around Dev-C++ `enum colors' conflict.
//
